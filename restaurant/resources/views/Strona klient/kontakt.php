...
<div class="row bg-light" style=" margin-left:auto; margin-right: auto; border-radius: 200px;" >
    <div class="col-md-12 d-flex justify-content-center mt-4" >
        <div class="login-container text-c animated flipInX" >

            <h3 class="text-dark" style="text-align: center">Kontakt</h3>
            ...
            <div class="container-content ">
                ...
                <p class="margin-t text-dark align " style="text-align: center;">
                    <small> Restaurant
                        <br>
                        Jarosław<br>
                        Ul. 3 Maja 44/053B<br>
                        37-500 Jarosław <br>
                        Restaurant &copy; 2021
                        nr. tel: 666-555-999 / 888-999-777<br>
                        adres e-mail: restaurant@wp.pl

...
<blockquote class="blockquote text-center text-light" style="margin-top: 15%; font-size: 50px;>
    <p class="mb-3 ">Serdecznie zapraszymy do naszej nowej restauracji!</p>
    <footer class="blockquote-footer text-light">Zjecie tutaj przepyszne <cite title="Source Title">dania</cite></footer>
</blockquote>
